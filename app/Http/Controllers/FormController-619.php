...
class FormController extends Controller
{
    ...
    public function list_of_form()
    {
        ...
        $data['forms'] = DB::table('forms')->orderBy('id', 'desc')->where('status',true)->get();
...
/* old one */
  ...
  public function create_form_table(Request $request)
    ...
    public function tableCreate(Request $request)
    {
        ...
        //   echo '<pre>';
        // 		print_r($request->var_id); die;
        $tough = $request->all();
        $array = array_slice($tough, 3);
    ...
    public function submit_form($id, $def = null)
    {
        ...
        // echo '<pre>';
		// 	print_r($data['date_submission']); die;
    ...
    public function individualReport($id,$tab)
    {
        ...
        $data['table_info'] = $data['form_tables'][0]->table_name;
        $data['data_value'] = DB::table($data['table_info'])->where('created_by',$id)->latest()->get();
        // echo '<pre>';
        // print_r($data['data_value']);
        // die;
        $data['data_rem'] = json_decode(json_encode($data['data_value'], true), true);
    ...
    public function generate_pdf($id)
    {
      ...
      $mpdf = new \Mpdf\MPDF([
        ...
        $dmkkamdf = $mpdf->writeHTML($this->pdfHTML($id));
        return $mpdf->Output('createdtable.pdf','D');
       

    }
/* individual generate pdf */
