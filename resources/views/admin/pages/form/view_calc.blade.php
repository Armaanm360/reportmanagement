...
@section('content')
    ...
    <div class="content">
        <div class="page-inner">
            ...
            <div class="entryform">
                <h3>Form generator > <span class="text-danger">Data Form</span></h3>
                <h1 id="form_format" class="text-info" style="display: none">data_form</h1>
                             ...
                             foreach ($data_value as $key => $value) {
                                ...
                                foreach ($value as $key_col => $col) {
                                    ...
                                    if ($key_col == 'authorize_user') {
                                        ...
                                        echo "<td id='$key_col' $styling_option><textarea name='$name' id='$key_col' class='calclass' inputmode='numeric'>$col</textarea><input type='hidden' name='colmns' value='$colmns'></td>";
                                    }
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('load', function() {
            ...
            /*  */
            // let totalRow = '',
            //     columnNo = $('table#myTable tr:first td').length + 5;
            ...
            // $('table#myTable').append('<tr>' + totalRow + '</tr>');
            ...
            // let sid = $('table tr:last > td ').val('15');


            // alert(sid);

            // let meow = $("table#myTable > tbody > tr:first > td ").length - 7
            ...
            $("input[type=hidden][name=total]").attr("readonly", true);
            ...
            $("textarea#total").attr("readonly", true);
        ...
        //     .then((willDelete) => {
        //         if (willDelete) {
        //             swal("Form Has been saved as Default Form", {
        //                 icon: "success",
        //             });
        //         } else {
        //             swal("unsaved");
