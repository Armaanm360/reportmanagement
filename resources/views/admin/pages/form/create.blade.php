            ...
            <div class="entryform">
                ...
                <form id="idForm">
                    ...
                    <div class="form-group col-md-12">
                        <h3 for="Financial Year" style="text-align:center">Form Information* <span class="addTable"
                                style="color: green;cursor: pointer;"></span></h3>
                        <h3>Subject :</h3>
                        <input type="text" name="form_name" class="form-control" id="form_name" onblur="onChangeHandle()"
