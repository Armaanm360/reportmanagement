    ...
    <div class="content">
              ...
              if ($header == 'id') {
               ...
               $styling_option = 'style="display:none"';
                                       ...
                                       $colmns = '';
										foreach ($value as $key_col => $col) {
                                         $colmns .= ','.$key_col;
										    ...
										    echo "<td id='$key_col' $styling_option><textarea name='$name' id='$key_col' class='styling_class' $check>$col</textarea><input type='hidden' name='colmns' value='$colmns'></td>";
                                            }
										}
				...
				echo '<tbody>';
                            ...
                            //             $newcol = '-';
                            //         } elseif ($key_col == 'created_by') {
                            //             $newcol = $usessrname->getUserName($col);
                            //         } elseif ($key_col == 'form_creator') {
                            //             $newcol = $usessrname->getUserName($col);
                            //         } else {
                            //             $newcol = $col;
                            //         }
                    ...
                    <a type="buton" class="btn btn-success" href="<?php echo url('send-form/' . $form[0]->id); ?>">অথোরাইয ইউসার এর নিকট প্রেরণ
                        করুন
                    </a>
                    <a type="buton" class="btn btn-success" href="<?php echo url('send-form-entry-user/' . $form[0]->id); ?>">এন্ট্রিইউসার এর নিকট
                        প্রেরণ করুন
                    </a>
                    {{-- @php
        ...
        <script type="text/javascript">
            ...
            window.addEventListener('load', function() {
                ...
                $("input[type=text][name=status]").val(0);
                ...
                $("input[type=text][name=status]").attr("readonly", true);
