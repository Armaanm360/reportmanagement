...
@section('content')
    ...
    <div class="content">
      ...
      <div class="printed-link" id="tablePrinting" style="width: min-content">
           ...
           $dept_name = $usessrname->getDeptNameUserWise($col);
              if ($key_col == 'id') {
                ...
                echo "<td $styling_option class='calclass'>$dept_name</td>";  
              }elseif($key_col == 'status'){
                echo "<td $styling_option>$col</td>";  
              }else{
                echo "<td $styling_option class='calclass'>$col</td>";
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <button type="button" id="decline" class="btn btn-warning">Decline</button>
                                            <div id="feedback">
                                                <form action="" id="feedback_form">
                                                    ...
                                                    <button type="button" id="Feedback_btn" class="btn btn-info">Sent
                                                        Feedback</button>
                                                </form>
                    ...
                    <button type="button" class="btn btn-danger"><a href="<?php // echo url('generate-pdf/' . $form[0]->id);
