...
<div class="content">
    <div class="page-inner">
        <div class="page-header" style="background-color: lightslategrey">
            <h4 class="page-title" style="margin-left: 18px;color: black;font-weight: bold"><img style="height: 48px;" src="{{asset('public')}}/logo.png"></h4>
            <ul class="breadcrumbs" style="color:black">
                <li class="nav-home">
                    <a href="#" style="color: black;font-weight: bold">
                        <i class="flaticon-home"  style="color: black;font-weight: bold"></i>
                    </a>
                </li>
                <li class="separator" >
                ...
                <li class="nav-item">
                    <a href="#"  style="color: black;font-weight: bold">{{$userData->designation_info->name}}</a>
                </li>
                <li class="separator">
                    <i class="flaticon-right-arrow"></i>
                </li>
                <li class="nav-item">
                    <a href="#"  style="color: black;font-weight: bold">{{$userData['name']}}</a>
                </li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <main>
                    <div id="float-background" class="argyle" data-classname="argyle">
                        <img style="margin-left:50%;margin-top:10%" src="{{asset('public')}}/logo.png">
                    </div>
...
class RUser {
	...
	updateDom() {
		...
		$("#user-infos-lastname").innerText = this.user.email;
		$("#user-infos-location").innerText = this.user.description;
...
////            console.log(this);
//		$("#user-card").classList.remove("loading");
//		$("#user-picture-img").src = this.name;
//		$("#user-infos-firstname").innerText = this.name;
//		$("#user-infos-lastname").innerText = this.name;
//		$("#user-infos-location").innerText = this.name;
//	}
//}
//
//const user = new RUser();
