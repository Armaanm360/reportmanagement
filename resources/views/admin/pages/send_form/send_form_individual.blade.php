    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">{{ __('Send Form Individually') }}</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">{{ __('Send Form Individually') }}</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <select class="form-control select2" id="process" name="process"
                                                    ...
                                                    @if (Auth::user()->user_category != 6)
                                                        <option value="individual">Individullay Send</option>
                                                    @else
                                                    @endif
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="block">
                                                <div class="form-group col-12">
                                                    <label for="Name" style="display: block;">{{ __('Select') }}
                                                    </label>
                                                    <select class="form-control" name="output_roles" id="output_roles">
    ...
    <script>
        $("#add_btn").click(function() {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('save-send-form-individual') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#process').on('change', function() {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('send-form-process-individual') }}",
                data: {
                    'process_type': this.value
                },
                success: function(data, textStatus, jqXHR) {

                    $('#output_roles').html(data.roles);
        ...
        $('#output_roles').on('change', function() {


            let roleid = $('#output_roles').val();
            ...
            $.ajax({
                ...
                method: "GET",
                url: "{{ url('get-role-wise-user') }}/" + roleid,
                success: function(data, textStatus, jqXHR) {
                    $('#user_id').html(data);
                }
            }).done(function(data) {
