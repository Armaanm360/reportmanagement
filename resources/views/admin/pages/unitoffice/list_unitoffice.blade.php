    ...
    <div class="content">
        ...
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">{{ __('Branch Users') }}</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">{{ __('Branch Users') }}</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                    <li class="nav-item">
                        <a href="#">{{ __('List of Branch Users') }}</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div style="width: 100%;text-align: right;float: right;margin-bottom: 7px"><button type="button"
                        ...
                        <i class="la flaticon-plus" style="font-size: 18px"></i> {{ __('Add Branch User') }}
                    </button></div>
                <div class="col-md-12">

                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('List of Branch Users') }}</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="basic-datatable" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($all_unitoffice as $row)
                                            ...
                                            @endif
                                            @if ($user->can('delete-unit-office'))
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Branch User') }}</h5>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php }?> --}}
                                            ...
                                            {{-- <div class="form-group col-12">
                                                <label for="Name"
                                                    style="display: block;">{{ __('Select Head Unit Office') }}</label>
                                                <select class="form-control select2" id="parent_id" name="parent_id"
                                                    style="width: 100%">
                                                    <option value="">{{ __('Select Head  Unit Office') }}</option>
                                                    @foreach ($all_unitoffice as $row)
                                                        <option value="{{ $row->id }}">{{ $row->name }}</option>
                                                    @endforeach
                                                </select>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalTable"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalTable">Edit Unit Office</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $("#add_form").submit(function(e) {
            ...
            $.ajax({
                ...
                window.location.href = "{{ url('unitoffice') }}";
                // location.reload();
            ...
            if (confirm('Are you sure?', true)) {
                $.ajax({
                    ...
                    success: function(data) {
                        alert('Hi');
                        notifiAlert('Alert!', 'Unit office deleted successfully');
                        return false;
                    }
                });
