...
<div class="content">
    ...
    <div class="page-inner">
        ...
        <form action="{{ url('form-2.2.2') }}" method="POST">
            @csrf
          <div class="rel-26">
                  ...
                  <tbody>
                      <div>
                          <tr class="row77">
                            ...
                            <td class="column5 style27 s"><input type="text" name="acquisition1_1" id="" value="-"></td>
                            <td class="column6 style27 s"><input type="text" name="acquisition2_1" id="" value="-"></td>
                            <td class="column7 style27 s"><input type="text" name="branch_responsible_implementation_1" id="" value="চিফ ইনোভেশন অফিসারের দপ্তর"></td>
                          </tr>
                          <tr class="row78">
