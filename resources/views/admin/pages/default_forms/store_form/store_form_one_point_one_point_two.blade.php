            ...
            <table border="1" width="100%" id="myTable">
               ...
               <tbody>
                  <tr class="row4">
                     ...
                     <td class="column1 style60 s style60" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_1" id="">বাংলাদেশ ইনস্টিটিউট অব ক্যাপিটাল মার্কেট</textarea></td>
                  ...
                  <tr class="row7">
                     ...
                     <td class="column1 style60 s style60" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_2" id="">বাংলাদেশ ইন্সুরেন্স একাডেমি</textarea></td>
                  ...
                  <tr class="row10">
                     ...
                     <td class="column1 style60 s style60" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_3" id="">বীমা উন্নয়ন ও নিয়ন্ত্রণ কর্তৃপক্ষ</textarea></td>
                  ...
                  <tr class="row13">
                     ...
                     <td class="column1 style60 s style60" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_4" id="">বাংলাদেশ মিউনিসিপাল ডেভেলপমেন্ট ফান্ড (বিএমডিএফ)</textarea></td>
                  ...
                  <tr class="row16">
                     ...
                     <td class="column1 style65 s style65" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_5" id="">বাংলাদেশ ব্যাংক</textarea></td>
                  ...
                  <tr class="row16">
                     ...
                     <td class="column1 style66 s style66" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_6" id="">বাংলাদেশ সিকিউরিটিজ অ্যান্ড এক্সচেঞ্জ কমিশন</textarea></td>
                  ...
                  <tr class="row17">
                     ...
                     <td class="column1 style77 s style77" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_7" id="">বাংলাদেশ সিকিউরিটিজ অ্যান্ড এক্সচেঞ্জ কমিশন</textarea></td>
                  ...
                  <tr class="row17">
                     ...
                     <td class="column3 style41 s"><textarea cols="30" rows="10" type="text" name="target_expense_7_1" id="">সেকেন্ড স্মল এন্ড মিডিয়াম সাইজড এন্টারপ্রাইজ ডেভেলপমেন্ট প্রজেক্ট (এসএমইডিপি-২)</textarea></td>
                  ...
                  <tr class="row18">
                     ...
                     <td class="column1 style88 s style88" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_8" id="">বাংলাদেশ সিকিউরিটিজ অ্যান্ড এক্সচেঞ্জ কমিশন</textarea></td>
