...
<div class="content">
    ...
    <div class="page-inner">
     ...
     <form id="submitForm" method="POST">
            ...
            <div class="rel-26">
                <h3 style="text-align: center;">{{$form_data['form_year']}} অর্থবছরের বাজেট বাস্তবায়ন অগ্রগতি</h3>
                <h5>১.১.১. সচিবালয়:</h5>
                <div>
                            </div>
                    ...
                    <thead>
                       ...
                       <tbody>
                        <tr class="row4">
                                ...
                                <td class="column1 style60 s style60" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_1" id="">শতকরা হার</textarea></td>
                              ...
                              <tr class="row7">
                                ...
                                <td class="column1 style60 s style60" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_2" id="">পণ্য ও সেবার ব্যবহার</textarea></td>
                            ...
                            <input cols="30" rows="10" type="hidden" name="row_id_2_2" value="2"> 
                              ...
                              <tr class="row10">
                                ...
                                <td class="column1 style60 s style60" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_3" id="">অ-আর্থিক সম্পদ</textarea></td>
                            ...
                            <input cols="30" rows="10" type="hidden" name="row_id_3_2" value="3"> 
                              ...
                              <tr class="row13">
                                ...
                                <td class="column1 style60 s style60" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_4" id="">সাধারণ থোক বরাদ্দ *</textarea></td>
                            ...
                            <input cols="30" rows="10" type="hidden" name="row_id_4_2" value="4"> 
                              ...
                              <tr class="row16">
                                ...
                                <td class="column1 style65 s style65" rowspan="3"><textarea cols="30" rows="10" type="text" name="activities_5" id="">মোট সচিবালয়</textarea></td>
