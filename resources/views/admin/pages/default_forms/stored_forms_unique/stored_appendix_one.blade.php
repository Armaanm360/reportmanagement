                ...
                <div class="header-item">
                  ...
                  <div class="listed-content">
                    <ul>
                        ...
                        <input type="hidden" name="unique_form_id" value="{{ $lines1 ->unique_form_id }}">
                            <li>১। <input type="text" name="appendix_one_subject_{{ $lines1 ->id }}" id="" value="{{ $lines1->appendix_one_subject  }}" readonly></li>
                        @endforeach
                        ...
                        <input type="hidden" name="row_id_l2[]" value="{{ $lines1 ->id }}">
                            <li>২| <input type="text" name="appendix_two_subject_{{ $lines1->id }}" id="" value="{{ $lines1->appendix_two_subject  }}" readonly></li>
                        @endforeach
                  ...
                  <div class="mt-4 item-table">
                      ...
                      <h6 align="center">@foreach ($lines as $lines1)
                          <input type="text" name="appendix_one_ka[]" id="" value="{{ $lines1->appendix_one_ka  }}" readonly>
                      @endforeach</h6>
                          ...
                          <tr class="row74">
                              {{-- <td class="column0 style7 s"><input type="text" name="serial_{{$item->id}}" id=""
                                    ...
                                    <input type="hidden" name="row_id_ka[]" value="{{$table_ka->id}}">
                                     <input type="hidden" name="unique_form_id" value="{{ $table_ka ->unique_form_id }}">
                  ...
                  <div class="mt-4 item-table">
                      ...
                      <table border="1">
                        ...
                        <tr class="row83">
                           <input type="hidden" name="unique_form_id" value="{{ $table_kha ->unique_form_id }}">
...
<script type="text/javascript">
    ...
    $("#submitForm").submit(function (e) {
        ...
        $.ajax({
            ...
            method: "POST",
            url: "{{url("update-form-appendix_one_update")}}",
            data: data,
            cache: false,
            contentType: false,
            processData: false,
