                ...
                <table border="1" width="100%" id="myTable">
                      <thead>
                          ...
                          <tr>
                              <td>
                                ...
                                <select class="form-control" id="damnbro" style="font-size: 12px;padding:0px">
                                          <option disabled selected>কোয়ার্টার নির্বাচন</option>
                                          <option id="q1">(জানুয়ারি ২০২১-মার্চ ২০২২)Q1</option>
                                          <option id="q2">(এপ্রিল   ২০২১-জুন ২০২২)Q2</option>
                                          <option id="q3">(জুলাই   ২০২১-সেপ্টেম্বর ২০২২)Q3</option>
                                          <option id="q4">(অক্টোবর ২০২১-ডিসেম্বর ২০২২)Q4</option>
                                        </select></td>
                              <td>
                                
                                <select class="form-control" id="" style="font-size: 12px;padding:0px">
                                          <option disabled selected>কোয়ার্টার নির্বাচন</option>
                                          <option>(জানুয়ারি ২০২১-মার্চ ২০২২)Q1</option>
                                          <option>(এপ্রিল   ২০২১-জুন ২০২২)Q2</option>
                                          <option>(জুলাই   ২০২১-সেপ্টেম্বর ২০২২)Q3</option>
                                          <option>(অক্টোবর ২০২১-ডিসেম্বর ২০২২)Q4</option>
                                        </select></td>
                              <td>
                      ...
                      <tbody>
                        <tr class="row1">
                            ...
                            <td class="column5 style7 s"><input type="number" name="acquisition2_1" id="txtCal1" value="">-</td>
                            <td class="column6 style7 s"><input type="number" name="acquisition3_1" id="txtCal1" value="">-</td>
                            <td class="column6 style7 s"><input type="number" name="acquisition4_1" id="txtCal1" value="">-</td>
                          ...
                          <input type="hidden" name="row_id" value="2">
                            ...
                            <td class="column4 style6 s"><input type="number" name="acquisition2_1" id="txtCal2" value=""></td>
                            <td class="column5 style7 s"><input type="number" name="acquisition2_2" id="txtCal2" value="">-</td>
                            <td class="column6 style7 s"><input type="number" name="acquisition2_3" id="txtCal2" value="">-</td>
                            <td class="column6 style7 s"><input type="number" name="acquisition2_4" id="txtCal2" value="">-</td>
                          ...
                          <input type="hidden" name="row_id" value="3">
                            ...
                            <td class="column4 style6 s"><input type="number" name="acquisition3_1" id="txtCal3" value=""></td>
                            <td class="column5 style7 s"><input type="number" name="acquisition3_2" id="txtCal3" value="">-</td>
                            <td class="column6 style7 s"><input type="number" name="acquisition3_3" id="txtCal3" value="">-</td>
                            <td class="column6 style7 s"><input type="number" name="acquisition3_4" id="txtCal3" value="">-</td>
                            <td class="column6 style7 s"><input type="number" readonly  name="acquisition3_total" id="total_sum_value3" value="">-</td>
