                ...
                <div class="header-item">
                  ...
                  <div class="header-item">
                    <div style="text-align: center;">
                     ...
                     <input type="text" name="heading_financial_1_{{ $heading_financial_1 -> id }}" id="" value="{{ $heading_financial_1-> heading_financial_1}}">
                     ...
                     <input type="text" name="heading_financial_2_{{ $heading_financial_2 -> id }}" id="" value="{{ $heading_financial_2-> heading_financial_2}}">
                      <input type="hidden" name="heading_financial_2_id" value="{{ $heading_financial_2-> id }}">
                     @endforeach</h4>
                    </div>
                    <div style="text-align: right;">
                      <h4> @foreach ($amount as $amount)
                     <input type="text" name="amount_{{ $amount -> id }}" id="" value="{{ $amount-> amount}}">
