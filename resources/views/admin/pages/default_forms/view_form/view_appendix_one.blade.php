...
<div class="content">
    ...
    <form action="{{ url('update-form-appendix_one_update') }}" method="post" id="submitForm">
        @csrf
              <div class="mt-4 item">
                  ...
                  <div class="listed-content">
                    <ul>
                        ...
                        <input type="hidden" name="row_id_l1[]" value="{{ $lines1 ->id }}">
                            <li>১। <input type="text" name="appendix_one_subject_{{ $lines1 ->id }}" id="" value="{{ $lines1->appendix_one_subject  }}"></li>
                        @endforeach


                        @foreach ($lines as $lines1)
                        <input type="hidden" name="row_id_l2[]" value="{{ $lines1 ->id }}">
                            <li>২| <input type="text" name="appendix_two_subject_{{ $lines1->id }}" id="" value="{{ $lines1->appendix_two_subject  }}"></li>
                        @endforeach
