                  ...
                  <div class="listed-content">
                    <ul>
                        @foreach ($mis8 as $mis8)
                            ...
                            <li><input type="text" name="budget_sub8_{{ $mis8 -> id  }}" id="" value="{{ $mis8 -> budget_sub8 }}"></li>
                        @endforeach
                  ...
                  <div class="mt-4 item-table">
                    <h6 align="center">
                        @foreach ($mis2009 as $mis2009)
                         <input type="hidden" name="nine2009_id" value="{{ $mis2009 -> id  }}">
                            <input type="text" name="budget_sub2009_{{ $mis2009 -> id  }}" id="" value="{{ $mis2009 -> budget_sub2009  }}">
                        @endforeach
                        
                       </h6>
                      <h6 align="center">
                          @foreach ($mis9 as $mis9)
                           <input type="hidden" name="nine_id" value="{{ $mis9 -> id  }}">
                              <input type="text" name="budget_sub9_{{ $mis9 -> id  }}" id="" value="{{ $mis9 -> budget_sub9  }}">
                          @endforeach
