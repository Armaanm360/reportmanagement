...
<div class="content">
    ...
    <div class="page-inner">
       ...
       <form action="{{ url('update-form-budget_branch')}}" id="submitForm" method="POST">
            ...
            <div class="item">
                ...
                <div class="listed-content">
                    <ul class="list-group">
                        ...
                        <input type="hidden" name="unique_form_id" value="{{$item->unique_form_id}}">
                        <li><input type="text" name="budget_{{ $item->id }}" id="" value="{{ $item -> budget }}" readonly>
            ...
            <div class="item">
                <div class="header-item">
                    <h3>বিষয়: <input type="text" name="susbject-2[]" id="" value="বার্ষিক কর্মসম্পাদন চুক্তি (এপিএ)" readonly>
                    </h3>
                </div>
                <div class="listed-content">
                    <ul>
                        ...
                        @foreach ($apa as $item)
                         <input type="hidden" name="unique_form_id" value="{{$item->unique_form_id}}">
                        <li><input type="text" name="apa_{{ $item -> id }}" id="" value="{{ $item -> apa }}" readonly></li>
