                ...
                <div class="header-item">
                  ...
                  <div class="listed-content">
                    <ul>
                        ...
                        <input type="hidden" name="unique_form_id" value="{{$head1->unique_form_id}}">
                             <li><input type="text" name="claim_1_head[]" id="" value="{{ $head1 ->claim_1_head  }}" readonly>
                                <input type="hidden" name="head_id_1" id="" value="{{ $head1 ->id  }}">
                        @endforeach
                     
                        <ul>
                            @foreach ($claim_1 as $claim_1)
                            <input type="hidden" name="unique_form_id" value="{{$claim_1->unique_form_id}}">
                                 <li><input type="text" name="claim_1_{{ $claim_1->id }}" id="" value="{{ $claim_1 ->claim_1 }}" readonly></li>
                    ...
                    <input type="hidden" name="unique_form_id" value="{{$head2->unique_form_id}}">
                             <li><input type="text" name="claim_2_head[]" id="" value="{{ $head2 -> claim_2_head  }}" readonly>
                            ...
                            <table width="100%" border="1">
                                ...
                                <tbody>
                                    @foreach ($table_six as $table_six)
                                     <tr class="row170">
                                    <input type="hidden" name="unique_form_id" value="{{$table_six->unique_form_id}}">
                    ...
                    <li>   @foreach ($head3 as $head3)
                        <input type="hidden" name="unique_form_id" value="{{$head3->unique_form_id}}">
                            <input type="text" name="claim_3_head[]" id="" value="{{ $head3 -> claim_3_head  }}" readonly>
                            <input type="hidden" name="head_id_3" id="" value="{{ $head3 -> id  }}">
                        @endforeach
                        <ul>
                            @foreach ($claim_3 as $claim_3)
                             <input type="hidden" name="unique_form_id" value="{{$claim_3->unique_form_id}}">
                                 <li><input type="text" name="claim_3_{{ $claim_3->id }}" id="" value="{{ $claim_3 -> claim_3 }}" readonly></li>
                            ...
                            <li>
                                ...
                                <ul>
                                  ...
                                  @foreach ($claim_3_1 as $claim_3_1)
                                    <input type="hidden" name="unique_form_id" value="{{$claim_3_1->unique_form_id}}">
                                 <li><input type="text" name="claim_3_1_{{ $claim_3_1->id }}" id="" value="{{ $claim_3_1 -> claim_3_1 }}" readonly></li>
