...
<div class="content">
 ...
 <form action="{{ url('update-form-appendix_three_update') }}" method="post" id="submitForm">
        @csrf
                  ...
                  <div class="listed-content">
                    <ul>
                        @foreach ($lines as $lines)
                            <li><input type="text" name="budget_sub_{{ $lines->id }}" id="" value="{{ $lines ->budget }}" readonly></li>
                            <input type="hidden" name="budget_id" id="" value="{{ $lines ->id }}">
                            <input type="hidden" name="unique_form_id" id="" value="{{ $lines ->unique_form_id }}">
                        @endforeach
                      ...
                      <tbody>
                          @foreach ($table_three as $item)
                             <tr>
                              ...
                              <input type="hidden" name="unique_form_id" id="" value="{{ $item ->unique_form_id }}">
            ...
            <script type="text/javascript">
                ...
                $("#submitForm").submit(function (e) {
                    ...
                    $.ajax({
                        ...
                        method: "POST",
                        url: "{{url("update-form-appendix_three_update")}}",
                        data: data,
                        cache: false,
                        contentType: false,
                        processData: false,
