...
<div class="content">
    ...
    <div class="page-inner">
            ...
            <div class="rel-26">
                ...
                <table border="1" width="100%" id="myTable">
                      ...
                      <tbody>
                        ...
                        {{-- @foreach ($check_group as $check_group)
                            <input type="text" name="check_group" value="{{ $check_group-> id }}">
                        @endforeach --}}
                        
                       {{-- @php
                      $damn = App\Models\GroupUser::where('user_id',Auth::user()->id)->get();
                       @endphp
                       @foreach ($damn as $damn)
                           <input type="text" name="group_id_get" value="{{$damn->group_id}}">
                       @endforeach --}}

                          @foreach ($group_get_pro as $group_get_pro)
                                 {{ $group_get_pro -> method }}
                            @endforeach
       ...
       {{-- @foreach ($group_get_pro as $group_get_pro)
         @if ($group_get_pro->duration > date('Y-m-d'))
