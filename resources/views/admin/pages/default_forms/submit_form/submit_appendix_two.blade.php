                  ...
                  <div class="listed-content">
                    <ul>
                        ...
                        <input type="hidden" name="unique_form_id" value="{{ $lines1 ->unique_form_id }}">
                            <li><input type="text" name="appendix_one_subject_{{ $lines1 ->id }}" id="" value="{{ $lines1->appendix_one_subject  }}" readonly></li>
                        @endforeach
                        ...
                        <input type="hidden" name="row_id_l2[]" value="{{ $lines1 ->id }}">
                         <input type="hidden" name="unique_form_id" value="{{ $lines1 ->unique_form_id }}">
                            <li><input type="text" name="appendix_two_subject_{{ $lines1->id }}" id="" value="{{ $lines1->appendix_two_subject  }}" readonly></li>
                        @endforeach
