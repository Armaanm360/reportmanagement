            ...
            <table border="1" width="100%" id="myTable">
               ...
               <tbody>
                  ...
                  <tr class="row1">
                     ...
                     <td class="column0 style7 s" @if($sub_rows != 0) rowspan="{{$subRow}}" @endif>
                     <textarea type="text" name="sub_row_activities_{{$subRow->id}}" id="" cols="30" rows="10">{{$subRow->activities}}</textarea>
                     </td>
