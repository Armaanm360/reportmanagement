                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                       ...
                                       <div class="form-group col-6" style="margin-top:30px"> 
                                           ...
                                           <label for="name">{{__('Select Institution ')}} :</label><br>
                                           @elseif(\Illuminate\Support\Facades\Auth::user()->hasRole('admin'))
                                           <label for="name">{{__('Select User ')}} :</label><br>
                                           @endif
                                        @foreach($all_institutions as $key=>$value)                                         
                                        <div class="selectgroup selectgroup-pills">
                                            <label class="selectgroup-item">
                                                <input type="checkbox" id="inlineCheckbox{{$key}}_{{ $loop->iteration }}" name="user[]" value="{{ $value->id }}" class="selectgroup-input" >
