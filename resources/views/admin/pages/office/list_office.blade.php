    ...
    <div class="content">
        ...
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">{{ __('Organization Users') }}</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">{{ __('Organization Users') }}</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                    <li class="nav-item">
                        <a href="#">{{ __('List of Organization Users') }}</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div style="width: 100%;text-align: right;float: right;margin-bottom: 7px"><button type="button"
                        ...
                        <i class="la flaticon-plus" style="font-size: 18px"></i> {{ __('Add Organization User') }}
                    </button></div>
                {{-- @if ($user->can('add-office'))
                <div style="width: 100%;text-align: right;float: right;margin-bottom: 7px"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong">
                        <i class="la flaticon-plus" style="font-size: 18px"></i> {{__('Add Office')}}
                    </button></div>
            @endif --}}
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('List of Organization Users') }}</h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Organization User') }}</h5>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php }?> --}}
                                            ...
                                            {{-- <div class="form-group col-12">
                                                <label for="Name"
                                                    style="display: block;">{{ __('Select Head Office') }}</label>
                                                <select class="form-control select2" id="parent_id" name="parent_id"
                                                    style="width: 100%">
                                                    <option value="">{{ __('Select Head Office') }}</option>
                                                    @foreach ($all_office as $row)
                                                        <option value="{{ $row->id }}">{{ $row->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group col-12">
                                                <label for="name">{{ __('Organization User') }} </label>
            ...
            if (confirm('Are you sure?', true)) {
                $.ajax({
                    ...
                    success: function(data) {
                        alert('Hi');
                        notifiAlert('Alert!', 'office deleted successfully');
                        return false;
                    }
                });
