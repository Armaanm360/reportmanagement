    ...
    <div class="content">
        ...
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">{{ __('Division') }}</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">{{ __('Division') }}</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                    <li class="nav-item">
                        <a href="#">{{ __('List of Division') }}</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div style="width: 100%;text-align: right;float: right;margin-bottom: 7px"><button type="button"
                        ...
                        <i class="la flaticon-plus" style="font-size: 18px"></i> {{ __('Add Division') }}
                    </button></div>

                {{-- @if ($user->can('add-division'))
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('List of Division') }}</h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Division') }}</h5>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalTable"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalTable">Edit Division</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
            ...
            if (confirm('Are you sure?', true)) {
                $.ajax({
                    ...
                    success: function(data) {
                        alert('Hi');
                        notifiAlert('Alert!', 'Division deleted successfully');
                        return false;
                    }
                });
