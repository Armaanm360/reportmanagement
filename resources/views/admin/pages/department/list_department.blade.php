    ...
    <div class="content">
        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div style="width: 100%;text-align: right;float: right;margin-bottom: 7px"><button type="button"
                        ...
                        <i class="la flaticon-plus" style="font-size: 18px"></i> {{ __('Add Department') }}
                    </button></div>

                {{-- @if ($user->can('add-department'))
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('List of Department') }}</h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Department') }}</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="row">
                                            ...
                                            {{-- <div class="form-group col-12">
                                                <label for="Name"
                                                    style="display: block;">{{ __('Select Head Department') }}</label>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalTable"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalTable">Edit Department</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
