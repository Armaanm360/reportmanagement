                        ...
                        <div class="form extra-class-1" style="width:100%">
                            ...
                            <div class="input">
                                <div class="inputBox">
                                    ...
                                    <input id="emauser_idil" type="text"
                                        class="form-control @error('user_id') is-invalid @enderror" name="user_id"
                                        value="{{ old('user_id') }}" required autocomplete="email" autofocus>
            ...
            <div class="container">
                ...
                <div class="col-xl-5 col-md-8">
                    ...
                    <button type="submit" class="btn btn-primary btn-block"style="font-size: 16px">
                        প্রবেশ <i class="fas fa-sign-in" aria-hidden="true"></i>
                    </button>
                    </form>
...
=======
>>>>>>> 05f2d20fcb715725260c4a0696d9cd07ca774e6b
@endsection
